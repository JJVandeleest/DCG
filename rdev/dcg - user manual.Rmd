...
```{r}
pdf(file = "./myeigenvalueplots.pdf", onefile = TRUE, width = 20, height = 40) # start a pdf graphic device
plotMultiEigenvalues(Ens_list, mfrow = c(10, 2), 
                     mar = c(1, 1, 1, 1),
                     line = -1.5, cex = 0.8) # plot in the pdf device you started
graphics.off() # close all plotting devices. You could find you plots in "./myeigenvalueplots.pdf"
```
